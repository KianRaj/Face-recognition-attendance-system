...
#****First image*****
        ...
        f_lbl.place(x=0,y=50,width=600,height=580)

#****Second image*****
        img_bottom = Image.open(r"college_images\face_detector2.jpg")
        img_bottom = img_bottom.resize((660,580),Image.ANTIALIAS)
        self.photoimg_bottom = ImageTk.PhotoImage(img_bottom)

        f_lbl = Label(self.root,image=self.photoimg_bottom)
        f_lbl.place(x=600,y=50,width=660,height=580)

#*****Button******
        b1 = Button(f_lbl,text="Face Recognition",command=self.face_recog,cursor="hand2",font = ("times new roman",15,"bold"),bg="darkgreen",fg="white")
        b1.place(x=250,y=510,width=160,height=30)
        ...
        def draw_boundary(img,classifier,scaleFactor,minNeighbours,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                if confidence>77:
                    ...
                    cv2.putText(img,f"Roll:{r}",(x,y-54),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),2)
                    cv2.putText(img,f"Name:{n}",(x,y-32),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),2)
